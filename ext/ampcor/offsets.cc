...
ampcor::py::offsets(py::module & m)
{
    ...
    pyCell
        ...
        .def_property(
            "ref",
            // the getter
            [](const offsets_cell_t & pxl) { return pxl.ref; },
            // the setter
            [](offsets_cell_t & pxl, std::pair<float, float> ref) { pxl.ref = ref; },
            // the docstring
        ...
        .def_property(
            "delta",
            // the getter
            [](const offsets_cell_t & pxl) { return pxl.shift; },
            // the setter
            [](offsets_cell_t & pxl, std::pair<float, float> delta) { pxl.shift = delta; },
            // the docstring
        ...
        .def_property(
            "gamma",
            // the getter
            [](const offsets_cell_t & pxl) { return pxl.gamma; },
            // the setter
            [](offsets_cell_t & pxl, float gamma) { pxl.gamma = gamma; },
            // the docstring
        ...
        .def_property(
            "confidence",
            // the getter
            [](const offsets_cell_t & pxl) { return pxl.confidence; },
            // the setter
            [](offsets_cell_t & pxl, float confidence) { pxl.confidence = confidence; },
            // the docstring
            "the level of confidence in the mapping")
        ...
        .def_property(
            "snr",
            // the getter
            [](const offsets_cell_t & pxl) { return pxl.snr; },
            // the setter
            [](offsets_cell_t & pxl, float snr) { pxl.snr = snr; },
            // the docstring
        ...
        .def_property(
            "covariance",
            // the getter
            [](const offsets_cell_t & pxl) { return pxl.covariance; },
            // the setter
            [](offsets_cell_t & pxl, float covariance) { pxl.covariance = covariance; },
            // the docstring
            "the covariance")
        // done
        ;
    ...
    pyOffsets
        ...
        .def(
            ...
            py::init([](py::tuple pyShape) { return offsets_constructor(pyShape); }),
            // the signature
            "shape"_a)
...
// helper definitions
auto
ampcor::py::offsets_constructor(py::tuple pyShape) -> offsets_t
{
    // extract the shape
