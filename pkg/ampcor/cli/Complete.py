...
# declaration
class Complete(ampcor.shells.command, family="ampcor.cli.complete"):
    """
    Assist with shell auto-completion
    """

    word = ampcor.properties.str()
    word.doc = "the word we are attempting to auto-complete"

    line = ampcor.properties.str()
    line.doc = "the partial command line"


    # administrative
    @ampcor.export(tip="generate completions candidates from a partial command line")
